    ...
    <div className="min-h-screen bg-background py-10 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-8">
          By using StudyHub, you agree to the following terms and conditions.
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-white dark:bg-card rounded-xl border border-gray-200 dark:border-gray-600 p-6 shadow-sm">
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
              All original content created by StudyHub is protected by
              copyright. Users may use the content for personal educational
              purposes only. Redistribution, commercial use, or reproduction
              without permission is prohibited.{" "}
              <button
                type="button"
                onClick={() => navigate({ to: "/admin" })}
                className="cursor-pointer text-gray-600 dark:text-gray-400 text-sm font-normal no-underline select-none bg-transparent border-none p-0 m-0 inline"
