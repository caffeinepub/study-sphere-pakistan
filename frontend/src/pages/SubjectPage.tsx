...
export default function SubjectPage() {
  const { classNum, subject } = useParams({ strict: false }) as { classNum: string; subject: string };
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="bg-card border-b border-border sticky top-0 z-10">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center gap-3">
          <Button variant="ghost" size="icon" onClick={() => navigate({ to: `/class/${classNum}` })}>
              ...
              {filtered.map((ch) => (
                ...
                >
                  ...
                  <div className="ml-auto flex gap-1">
                    ...
                    {ch.audioUrl1 && <Badge variant="secondary" className="text-xs">Audio</Badge>}
