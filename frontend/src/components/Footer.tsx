    ...
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-heading font-semibold text-gray-900 dark:text-white mb-3">Quick Links</h3>
          ...
          {/* Legal */}
          <div>
            <h3 className="font-heading font-semibold text-gray-900 dark:text-white mb-3">Legal</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
              Content is for educational purposes only. Not affiliated with any board.
            </p>
            <button
